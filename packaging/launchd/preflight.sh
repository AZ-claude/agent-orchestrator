...
case "$status" in
  *"agent-orchestrator-preinstall-delta"*"version"*|*"agent-orchestrator-qwen-opencode-worker-preinstall-delta"*"version"*|*"agent-orchestrator-production"*"version"*|*"agent-orchestrator-pilot"*"version"*) ;;
